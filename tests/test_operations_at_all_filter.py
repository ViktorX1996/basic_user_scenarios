...
def test_complete_one():
    ...
    todomvc.should_been_completed('a')
    todomvc.should_been_active('b', 'c')
...
def test_activate_one():
    ...
    todomvc.should_been_active('a')\
        .should_been_completed('b', 'c')\
...
def test_complete_all():
    ...
    todomvc.should_been_active()\
        .should_been_completed('a', 'b', 'c')\
...
def test_activate_all():
    ...
    todomvc.should_been_active('a', 'b', 'c')\
        .should_been_completed()\
        .should_have_items_left(3)


def test_by_clear_completed():
    todomvc.visit()
    todomvc.add('a', 'b', 'c')
    todomvc.toggle('c')
    ...
    todomvc.should_been_active('a', 'b')\
        .should_have_items_left(2)
